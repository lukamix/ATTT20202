...
public class Schnorr {
    ...
    */
    ...
    //Client
    public static BigInteger checkVerify(String[] verify,BigInteger rC,String hpw,String id,BigInteger w) throws GeneralSecurityException{
        if(verify[0]!=null){
            BigInteger sk = new BigInteger(verify[1]).modPow(rC, GeneratedPrime.p);
            String Dskn = AES.DeccryptText(verify[0], sk.toString());
